...
export const DATA_PLANS: Record<string, DataPlan[]> = {
  MTN: [
    { id: 'mtn_sme_weekly', name: '1GB (SME Weekly) (7 Days)', price: 549, networkId: 1, variation_id: '9' }
  ],
  GLO: [
    { id: 'glo_200mb_corporate', name: 'Glo 200MB (Corporate) (30 Days)', price: 130, networkId: 2, variation_id: '50' },
    { id: 'glo_gb_30days_corporate', name: '1GB (Corporate) (30 Days)', price: 540, networkId: 2, variation_id: '52' },

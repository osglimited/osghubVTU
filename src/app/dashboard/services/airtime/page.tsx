...
export default function AirtimeServicePage() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: `Airtime purchase completed. New balance: ₦${nextBalance.toLocaleString()}` });
    } catch (e: any) {
    ...
    <DashboardGuard>
      <DashboardLayout>
        <div className="max-w-xl space-y-6">
          <h1 className="text-3xl font-bold text-[#0A1F44]">Airtime Top-up</h1>
          {message && (
